...
DROP DATABASE IF EXISTS `LBD2023G11Veterinaria`;
...
-- ----------------------------------------------------
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('45678234',54321098,'2023-04-22 15:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67891234',54321098,'2023-04-22 12:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('38976543',54321098,'2023-04-21 10:15:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67893456',54321098,'2023-04-20 09:45:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('24987654',54321098,'2023-04-19 14:20:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('45678234',54321098,'2023-04-18 11:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67891234',54321098,'2023-04-17 15:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('38976543',98765432,'2023-04-16 10:45:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67893456',98765432,'2023-04-15 14:15:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('24987654',98765432,'2023-04-14 08:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('45678234',98765432,'2023-04-13 16:45:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67891234',98765432,'2023-04-12 13:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('38976543',98765432,'2023-04-11 12:15:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67893456',54321098,'2023-04-10 09:45:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('24987654',54321098,'2023-04-09 11:20:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('45678234',54321098,'2023-04-08 14:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67891234',54321098,'2023-04-07 15:00:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('38976543',87654321,'2023-04-06 08:45:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67893456',87654321,'2023-04-05 11:15:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('24987654',87654321,'2023-04-04 12:20:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('24987654',87654321,'2023-04-09 11:20:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('45678234',87654321,'2023-04-08 14:30:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67891234',54321098,'2023-04-07 15:24:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('38976543',54321098,'2023-04-06 08:01:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('67893456',54321098,'2023-04-05 12:45:00' );
INSERT INTO Ventas (`Cliente_DNI`,`Vendedor_DNI`,`Fecha`) VALUES ('24987654',54321098,'2023-04-04 12:30:00' );
...
INSERT INTO Citas (Mascota_idMascota, Mascota_Cliente_DNI, Veterinario_DNI, Fecha, Consultorio, Monto)
VALUES (19, 67891234, 24987654, '2023-03-01 20:30:00', 'A4', 60.00);
	...
	ON p.DNI = c.Mascota_Cliente_DNI WHERE p.DNI = '67891234' AND fecha BETWEEN '2023-03-01' AND '2023-05-30'  
	ORDER BY DATE(c.Fecha) DESC, TIME(c.Fecha ) ASC;
...
-- Ordenar cronológicamente
    ...
    SELECT 
        ...
        v.Fecha,
        v.Servicio,
        SUM(lv.PrecioUnidad*lv.Cantidad) AS 'Total'
    ...
    GROUP BY p.DNI,v.Fecha,v.Servicio,v.idVentas
...
-- 4. Dada una cita mostrar el historial
	SELECT 
		c.idCita,
        h.idHistoria,
        h.Citas_Mascota_idMascota,
        h.Citas_Mascota_Cliente_DNI AS 'DNI Cliente',
        h.Citas_Veterinario_DNI AS 'DNI Veterinario',
        h.Titulo,
        h.Descripcion,
        h.Imagenes 
	FROM Historias h JOIN Citas c 
	ON c.idCita=h.Citas_idCita 
    AND c.Veterinario_DNI = h.Citas_Veterinario_DNI 
    AND c.Mascota_idMascota = h.Citas_Mascota_idMascota
    AND c.Mascota_Cliente_DNI = h.Citas_Mascota_Cliente_DNI 
    WHERE c.idCita=3;
...
-- 7. Hacer un ranking con los horarios más usados para los turnos.
	...
	SELECT 
		Time(Fecha), 
        COUNT(Time(Fecha)) as 'Total de citas' 
    FROM Citas
    GROUP BY Time(Fecha) 
    ORDER BY COUNT(Time(Fecha)) DESC;
...
SELECT 
    ...
    m.sexo,
    m.Mascota,
    m.Personas_DNI as 'Dueno',
    c.Fecha,
    h.Titulo,
    h.Descripcion,
    h.Imagenes 
FROM Mascotas AS m JOIN Citas as c ON m.idMascotas = c.Mascota_idMascota AND c.Mascota_Cliente_DNI = m.Personas_DNI
...
-- Trigger Borrado Mascota
DROP TRIGGER IF EXISTS `Trig_Mascotas_Borrado` ;

DELIMITER //
CREATE TRIGGER `Trig_Mascotas_Borrado` 
...
-- Trigger para impedir borrado en tabla AuditoriaMascotas

DROP TRIGGER IF EXISTS `Trig_AuditoriaTMascotas_Borrado` ;
DELIMITER //
CREATE TRIGGER `Trig_AuditoriaTMascotas_Borrado` 
BEFORE DELETE ON `AuditoriaMascotas` FOR EACH ROW
BEGIN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Error: no se puede borrar de la tabla AuditoriaMascotas';
END //
DELIMITER ;

-- Trigger Modificado Mascota
...
DELIMITER // 
CREATE PROCEDURE AltaMascota( 
    mPersonas_DNI INT,
	mNombre VARCHAR(25), 
    mFechaDeNacimiento DATE, 
    mTipo ENUM('Perro', 'Gato','Pajaro', 'Pez', 'Hamster'),
    murlFoto VARCHAR(2083),
    msexo ENUM('Macho','Hembra'),
    OUT mensaje VARCHAR(100))
    
-- Crea una mascota siempre y cuando no haya otro con el mismo id 
SALIR:BEGIN 
		IF (mPersonas_DNI IS NULL) OR (mNombre IS NULL) OR (mFechaDeNacimiento IS NULL) OR (mTipo IS NULL) OR
		(murlFoto IS NULL) OR (msexo IS NULL) THEN 
			SET	mensaje = 'Error en los datos de la mascota';
			LEAVE SALIR;
    	ELSEIF NOT EXISTS (SELECT * FROM Personas WHERE DNI = mPersonas_DNI) THEN 
 			SET mensaje = 'No existe esa persona'; 
			LEAVE SALIR;            
		ELSE 
			START TRANSACTION; 
				INSERT INTO Mascotas (Personas_DNI, Mascota, FechaDeNacimiento, Tipo, urlFoto, sexo)
                VALUES(mPersonas_DNI, mNombre,mFechaDeNacimiento, mTipo,murlFoto,msexo);
                SET mensaje = 'Mascota creada con exito';
			COMMIT; 
	END IF; 
END 
// DELIMITER ; 
...
-- Modifica una moscota siempre y cuando coincidan el id de la mascota y el dni de la persona
 
 SALIR:BEGIN 
		IF (midMascotas IS NULL) OR (mPersonas_DNI IS NULL) OR	(mNombre IS NULL) OR (mFechaDeNacimiento IS NULL) OR (mTipo IS NULL) OR
		(murlFoto IS NULL) OR (msexo IS NULL) THEN 
			SET	mensaje = 'Error en los datos de la mascota';
			LEAVE SALIR;
		...
		ELSE 
			START TRANSACTION; 
				UPDATE Mascotas 
                SET Mascota = mNombre, 
					FechaDeNacimiento = mFechaDeNacimiento, 
                    Tipo = mTipo, 
                    urlFoto = murlFoto, 
                    sexo = msexo 
				WHERE idMascotas = midMascotas AND Personas_DNI = mPersonas_DNI; 
                SET mensaje = 'Mascota modificada con exito';
			COMMIT; 
	END IF; 
END 
// DELIMITER ;
...
DELIMITER // 
CREATE PROCEDURE BorrarMascota( 
	midMascotas INT,
	mPersonas_DNI INT,
    OUT mensaje VARCHAR(100)) 

SALIR:BEGIN 
	IF (midMascotas IS NULL) OR (mPersonas_DNI IS NULL) THEN 
			SET	mensaje = 'Error en los datos de la mascota';
			LEAVE SALIR;
    ELSEIF NOT EXISTS (SELECT * FROM Mascotas WHERE idMascotas = midMascotas AND Personas_DNI = mPersonas_DNI) THEN 
			SET	mensaje = 'No existe esa mascota con esa persona';
...
SALIR: BEGIN
	IF (midMascota IS NULL) THEN 
			SET	mensaje = 'Error en los datos de la mascota';
			LEAVE SALIR;
    ELSEIF NOT EXISTS (SELECT * FROM Mascotas WHERE idMascotas = midMascota) THEN 
			SET	mensaje = 'No existe esa mascota';
			LEAVE SALIR; 
	ELSE 
		START TRANSACTION; 
			SELECT 
				...
				sexo
			FROM Mascotas 
            WHERE idMascotas = midMascota;
			SET	mensaje = 'Busqueda correcta';
		COMMIT; 
	END IF; 
END // 
DELIMITER ; 
...
-- orden cronológico. (en una sola consulta)

DROP PROCEDURE IF EXISTS MostrarTurnos;

DELIMITER //
CREATE PROCEDURE MostrarTurnos(
	pDNI int, 
	pFechaDesde DATE, 
    pFechaHasta DATE,
    OUT mensaje VARCHAR(100))
BEGIN
    ...
    IF(pDNI IS NULL OR pFechaDesde IS NULL OR pFechaHasta IS NULL) THEN
		SET	mensaje = 'Datos invalidos';
    ELSEIF NOT EXISTS (SELECT * FROM Personas WHERE DNI = pDNI) THEN 
        SET	mensaje = 'No existe esa persona';
	ELSE
		START TRANSACTION;
		SELECT 
			...
			c.Mascota_idMascota
		FROM Personas p JOIN Citas c
		ON p.DNI = c.Mascota_Cliente_DNI WHERE p.DNI = pDNI AND fecha BETWEEN pFechaDesde AND pFechaHasta  
		ORDER BY DATE(c.Fecha) DESC, TIME(c.Fecha ) ASC;
...
SALIR: BEGIN 
	IF(mes IS NULL) THEN 
		SET mensaje = 'Error al ingresar el mes';
		LEAVE SALIR;
	ELSEIF(mes<=0 OR mes>12 ) THEN 
		SET mensaje = 'Mes incorrecto';
		LEAVE SALIR;
    ELSE
		START TRANSACTION;
			SELECT 
                ...
                i.Insumo,
               IFNULL(SUM(lv.Cantidad),0) as 'Total de Ventas',
              IFNULL(SUM(lc.Cantidad),0) as 'Total de Compras'
			FROM Insumos i 
            LEFT JOIN LineaDeVentas lv  ON i.idInsumos = lv.idInsumos
            LEFT JOIN LineaDeCompras lc ON i.idInsumos = lc.idInsumos
            GROUP BY i.Insumo,i.IdInsumos
			ORDER BY idInsumos;
...
DELIMITER // 
CREATE PROCEDURE BusquedaMascotaCliente(
	pDNI INT, 
    OUT Mensaje VARCHAR(100))
    -- Realiza una busqueda por el dni de la persona y devuelve sus mascotas
    -- Si ingresa valores incorrectos devolvera un mensaje de error
SALIR: BEGIN
	IF (pDNI IS NULL) THEN 
			SET	mensaje = 'Error en los datos de la persona';
			LEAVE SALIR;
    ELSEIF NOT EXISTS (SELECT * FROM Personas WHERE DNI = pDNI) THEN 
			SET	mensaje = 'No existe esa persona';
			LEAVE SALIR; 
	ELSE 
		START TRANSACTION; 
			SELECT 
				...
				m.urlFoto,
				m.sexo
			FROM Mascotas AS m JOIN Personas AS p ON m.Personas_DNI = p.DNI
            WHERE p.DNI= pDNI;
            SET	mensaje = 'Busqueda correcta';
		COMMIT; 
	END IF; 
...
CALL BusquedaMascotaCliente(11111,@resultado); -- ERROR --> NO EXISTE ESA PERSONA
SELECT @resultado AS Mensaje;

CALL BusquedaMascotaCliente(0,@resultado); -- ERROR --> NO EXISTE ESA PERSONA
SELECT @resultado AS Mensaje;
